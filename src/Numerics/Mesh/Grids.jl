...
struct DiscontinuousSpectralElementGrid{
    ...
    function DiscontinuousSpectralElementGrid(
        ...
        elemtobndy = DeviceArray(FloatType.(topology.elemtobndy))
        vmap⁻ = DeviceArray(FloatType.(vmap⁻))
        vmap⁺ = DeviceArray(FloatType.(vmap⁺))
        vmapsend = DeviceArray(FloatType.(vmapsend))
        vmaprecv = DeviceArray(FloatType.(vmaprecv))
        activedofs = DeviceArray(FloatType.(activedofs))
